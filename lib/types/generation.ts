...
export interface StylePreferences {
  ...
  language: string; // 'zh-CN', 'en-US', 'es-ES'
}
...
export interface UserRequirements {
  ...
  language: 'zh-CN' | 'en-US' | 'es-ES'; // Course language - critical for generation
...
export interface SceneOutline {
  ...
  order: number;
  language?: 'zh-CN' | 'en-US' | 'es-ES'; // Generation language (inherited from requirements)
