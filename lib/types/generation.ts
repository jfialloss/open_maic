...
export interface UserRequirements {
  ...
  deepInteraction?: boolean; // Backward compatibility for CORDIS UI
  language?: string; // Backward compatibility for CORDIS UI
  subject?: string; // Backward compatibility for CORDIS UI
  grade?: string; // Educational grade (e.g. 2EGB)
  topic?: string; // Specific syllabus topic or "LIBRE"
}
...
export interface SceneOutline {
  ...
  languageDirective?: string; // High-level language directive
