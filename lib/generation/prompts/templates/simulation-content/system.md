...
- Common bug: Button changes text to "Reset" but clicking it doesn't reset
...
- Button text should reflect what will happen when clicked:
  ...
  - "Reset" / "Restart" → Reset and start fresh (when ended)
  IMPORTANT: Make sure to translate these labels to the user's requested language.
