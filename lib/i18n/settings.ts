export const settingsZhCN = {
  settings: {
    ...
    providerGoogleTTS: 'Google / Gemini Cloud TTS',
    ...
    providerGoogleASR: 'Google / Gemini Cloud Speech-to-Text',
    providerGeminiASR: 'Gemini ASR (Google AI Studio)',
...
export const settingsEsES = {
  settings: {
    ...
    theme: 'Tema',
    themeDesc: 'Seleccionar modo de tema (Claro/Oscuro/Sistema)',
    themeOptions: {
      light: 'Claro',
      dark: 'Oscuro',
      system: 'Sistema',
    ...
    apiBaseUrl: 'URL del Endpoint de la API',
    apiBaseUrlDesc: 'Configura la URL de tu endpoint de la API',
    apiKeyRequired: 'La clave API no puede estar en blanco',
    model: 'Configuración de Modelo',
    modelDesc: 'Configurar modelos de IA',
    modelPlaceholder: 'Introduce o selecciona el nombre del modelo',
    ttsModel: 'Modelo TTS',
    ttsModelDesc: 'Configurar modelos TTS',
    ttsModelPlaceholder: 'Introduce o selecciona el nombre del modelo TTS',
    ttsModelOptions: {
      openaiTts: 'OpenAI TTS',
      azureTts: 'Azure TTS',
    },
    testConnection: 'Probar Conexión',
    testConnectionDesc: 'Probar que la configuración API actual está disponible',
    testing: 'Probando...',
    agentSettings: 'Ajustes de Agentes',
    agentSettingsDesc:
      'Select the agents to participate in the conversation. Select 1 for single agent mode, select multiple for multi-agent collaborative mode.',
    agentMode: 'Modo de Agente',
    agentModePreset: 'Preajuste',
    agentModeAuto: 'Autogenerar',
    agentModeAutoDesc: 'La IA generará roles apropiados automáticamente',
    autoAgentCount: 'Cantidad de Agentes',
    autoAgentCountDesc: 'Número de agentes a autogenerar (incluyendo profesor)',
    atLeastOneAgent: 'Por favor selecciona al menos 1 agente',
    singleAgentMode: 'Modo de Agente Único',
    directAnswer: 'Respuesta Directa',
    multiAgentMode: 'Modo Multi-Agente',
    agentsCollaborating: 'Discusión Colaborativa',
    agentsCollaboratingCount: '{count} agentes seleccionados para la discusión colaborativa',
    maxTurns: 'Turnos Máximos de Discusión',
    maxTurnsDesc:
      'The maximum number of discussion turns between agents (each agent completes actions and reply counts as one turn)',
    priority: 'Prioridad',
    actions: 'Acciones',
    ...
    agentNames: {
      ...
      'default-3': 'El Bromista',
      'default-4': 'Mente Curiosa',
    ...
    agentDescriptions: {
      'default-1': 'Instructor principal con explicaciones claras y estructuradas',
      'default-2': 'Apoya el aprendizaje y ayuda a clarificar puntos clave',
      'default-3': 'Aporta humor y energía al aula',
      'default-4': 'Siempre curioso, ama preguntar por qué y cómo',
      'default-5': 'Registra y organiza diligentemente las notas de clase',
      'default-6': 'Piensa profundamente y explora la esencia de los temas',
    },
    close: 'Cerrar',
    save: 'Guardar',
    // Provider settings
    providers: 'LLM (Modelos)',
    addProviderDescription: 'Añade proveedores de modelos personalizados para ampliar los modelos de IA disponibles',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    outputWindow: 'Salida',
    // Provider management
    addProviderButton: 'Añadir',
    addProviderDialog: 'Añadir Proveedor de Modelos',
    providerName: 'Nombre',
    providerNamePlaceholder: 'ej., Mi Proxy de OpenAI',
    ...
    deleteProviderConfirm: '¿Estás seguro de que quieres eliminar a este proveedor?',
    cannotDeleteBuiltIn: 'No se puede eliminar el proveedor incorporado',
    ...
    resetSuccess: 'Restablecido con éxito a la configuración predeterminada',
    saveSuccess: 'Ajustes guardados',
    saveFailed: 'Fallo al guardar ajustes, por favor intenta de nuevo',
    cannotDeleteBuiltInModel: 'No se puede eliminar el modelo incorporado',
    cannotEditBuiltInModel: 'No se puede editar el modelo incorporado',
    modelIdRequired: 'Por favor, ingresa el ID del modelo',
    noModelsAvailable: 'No hay modelos disponibles para pruebas',
    providerMetadata: 'Metadatos del Proveedor',
    // Model editing
    editModel: 'Editar Modelo',
    editModelDescription: 'Editar la configuración y características del modelo',
    addNewModel: 'Nuevo Modelo',
    addNewModelDescription: 'Añadir una nueva configuración de modelo',
    modelId: 'ID de Modelo',
    modelIdPlaceholder: 'ej., gpt-4o',
    modelName: 'Nombre de Visualización',
    modelNamePlaceholder: 'Opcional',
    modelCapabilities: 'Características',
    advancedSettings: 'Ajustes Avanzados',
    contextWindowLabel: 'Ventana de Contexto',
    contextWindowPlaceholder: 'ej., 128000',
    outputWindowLabel: 'Tokens Máximos de Salida',
    ...
    step1ConfigureProvider:
      'Go to "Model Providers", select or add a provider, and configure connection settings (API key, Base URL, etc.)',
    step2SelectModel: 'Selecciona el modelo que deseas ocupar en "Modelo Activo" abajo',
    step3StartUsing: 'Después de guardar, el sistema ocupará el modelo seleccionado',
    activeModel: 'Modelo Activo',
    activeModelDescription: 'Selecciona el modelo para las pláticas y la generación de contenido',
    selectModel: 'Seleccionar Modelo',
    searchModels: 'Buscar modelos',
    noModelsFound: 'No se encontraron modelos coincidentes',
    noConfiguredProviders: 'Sin proveedores configurados',
    configureProvidersFirst:
      'Please configure provider connection settings in "Model Providers" on the left',
    ...
    asrSection: 'Reconocimiento Automático del Habla (ASR)',
    ttsDescription: 'TTS (Texto a Voz) - Convierte el texto escrito a voz oral',
    asrDescription: 'ASR (Reconocimiento del Habla) - Convierte tu propia  voz oral hacia texto escrito',
    enableTTS: 'Habilitar generación de habla',
    ttsEnabledDescription: 'Cuando se activa, el audio del habla será generado al tiempo de armar un curso',
    enableASR: 'Habilitar Reconocimiento del Habla',
    asrEnabledDescription: 'Cuando se activa, estudiantes pueden usar el micrófono para grabar su entrada',
    ttsProvider: 'Proveedor de Síntesis de TTS',
    ...
    ttsBaseUrl: 'URL Base',
    ttsApiKey: 'Clave API',
    asrProvider: 'Proveedor de Escucha de ASR',
    asrLanguage: 'Idioma de Reconocimiento',
    asrBaseUrl: 'URL Base',
    asrApiKey: 'Clave API',
    enterApiKey: 'Introducir Clave API',
    enterCustomBaseUrl: 'Introducir URL Base personalizada',
    browserNativeNote: 'El reconocimiento de voz nativo a tu buscador no requiere configurador y es totalmente gratis',
    // Audio provider names
    providerOpenAITTS: 'OpenAI TTS (gpt-4o-mini-tts)',
    providerAzureTTS: 'Azure TTS',
    providerGLMTTS: 'GLM TTS',
    ...
    asrResult: 'Resultado del Reconocimiento',
    ...
    microphoneAccessFailed: 'Fallo al acceder al micrófono',
    asrResultPlaceholder: 'El resultado del reconocimiento se mostrará después de grabar',
    ...
    voiceApiKeyRequired: 'Se requiere Clave API',
    voiceBaseUrlRequired: 'Se requiere URL Base',
    ttsTestTextPlaceholder: 'Ingrese texto para convertir',
    ttsTestTextDefault: 'Hola, esta es una voz de prueba generada para probar la configuración de audio.',
    ...
    videoGenerationDisabledHint:
      'When enabled, videos will be auto-generated during course creation',
    videoSettings: 'Generación de Video',
    videoSection: 'Text to Video',
    videoProvider: 'Video Generation Provider',
    videoModel: 'Video Generation Model',
    providerSeedance: 'Seedance (ByteDance)',
  ...
  profile: {
    ...
    uploadAvatar: 'Subir',
    bioPlaceholder: 'Cuéntanos sobre ti — el profesor de Inteligencia Artificial personalizará las clases para ti...',
    avatarHint: 'Tu avatar aparecerá en las interacciones y chats de la clase',
    fileTooLarge: 'Imagen muy grande — por favor elige una de menos de 5 MB',
    invalidFileType: 'Por favor selecciona un archivo de imagen',
    editTooltip: 'Haz click para editar',
  },
  media: {
    imageCapability: 'Generación de Imágenes',
    imageHint: 'Generate images in slides',
    videoCapability: 'Generación de Video',
    videoHint: 'Generate videos in slides',
    ttsCapability: 'Texto a Voz',
    ttsHint: 'AI teacher speaks aloud',
