export const stageZhCN = {
  ...
  whiteboard: {
    ...
    resetView: '重置视图',
    zoomHint: '滚轮缩放 / 拖拽平移 / 双击重置',
    restoreError: '恢复历史记录失败：',
  },
  quiz: {
    title: '随堂测验',
    subtitle: '检测你的学习成果',
...
export const stageEsES = {
  stage: {
    currentScene: 'Escena Actual',
    generating: 'Generando...',
    paused: 'Pausado',
    generationFailed: 'La generación falló',
    confirmSwitchTitle: 'Cambiar Escena',
    confirmSwitchMessage:
      'Un tema está en progreso. Cambiar escenas terminará el tema actual. ¿Estás seguro?',
    generatingNextPage: 'Se está generando la escena, por favor espera...',
  },
  whiteboard: {
    title: 'Pizarra Interactiva',
    open: 'Abrir Pizarra',
    clear: 'Limpiar Pizarra',
    minimize: 'Minimizar Pizarra',
    ready: 'La pizarra está lista',
    readyHint: 'Los elementos aparecerán aquí cuando la IA los agregue',
    clearSuccess: 'Pizarra limpiada con éxito',
    clearError: 'Hubo un error al limpiar la pizarra: ',
    history: 'Historial',
    restore: 'Restaurar',
    beforeClear: 'Antes de limpiar',
    beforeAIClear: 'Antes de limpiar por IA',
    noHistory: 'Sin historial',
    restored: 'Restaurado',
    elementCount: '{count} elementos',
    resetView: 'Restablecer vista',
    zoomHint: 'Rueda para acercar / Arrastrar para mover / Doble clic para restablecer',
    restoreError: 'Error al restaurar la pizarra: ',
  },
  quiz: {
    title: 'Cuestionario',
    ...
    multipleChoiceHint: '(Elección múltiple: selecciona todas las respuestas correctas)',
    inputPlaceholder: 'Escribe tu respuesta aquí...',
    charCount: 'caracteres',
    yourAnswer: 'Tu respuesta:',
    notAnswered: 'Sin responder',
    aiComment: 'Comentarios de la IA',
    singleChoice: 'Simple',
    ...
    answering: 'En progreso',
    submitAnswers: 'Enviar respuestas',
    aiGrading: 'La IA está calificando...',
  ...
  roundtable: {
    ...
    discussionEnded: 'La discusión terminó',
    qaEnded: 'Q&A terminado',
    thinking: 'Pensando',
    yourTurn: 'Tu turno',
    stopDiscussion: 'Detener Discusión',
    autoPlay: 'Autoreproducción',
    autoPlayOff: 'Detener autoreproducción',
    speed: 'Velocidad',
  },
  pbl: {
    legacyFormat: 'Esta escena PBL usa un formato antiguo. Por favor regenera el curso.',
    emptyProject: 'El proyecto PBL no ha sido generado aún. Por favor, crea uno mediante la generación del curso.',
    roleSelection: {
      title: 'Elige tu Rol',
      description: 'Selecciona un rol para empezar a colaborar en el proyecto',
    },
    workspace: {
      restart: 'Reiniciar',
      confirmRestart: '¿Resetear todo el progreso?',
      confirm: 'Confirmar',
      cancel: 'Cancelar',
    },
    issueboard: {
      title: 'Panel de Tareas',
      noIssues: 'Aún no hay tareas',
      statusDone: 'Hecho',
      statusActive: 'Activa',
      statusPending: 'Pendiente',
    },
    chat: {
      title: 'Discusión del Proyecto',
      currentIssue: 'Tarea Actual',
      mentionHint: 'Usa @question para preguntar, @judge para mandar a revisión',
      placeholder: 'Escribe un mensaje...',
      send: 'Enviar',
      welcomeMessage:
        '¡Hola! Soy tu Agente de Preguntas para esta tarea: "{title}"\n\nPara orientar tu trabajo, he preparado algunas preguntas para ti:\n\n{questions}\n\n¡Siéntete libre de usar @question conmigo en cualquier momento si necesitas ayuda o alguna aclaración!',
      issueCompleteMessage: '¡Tarea "{completed}" completada! Pasando a la siguiente tarea: "{next}"',
      allCompleteMessage: '🎉 ¡Todas las tareas se han completado! ¡Un estupendo trabajo en el proyecto!',
    },
    guide: {
      ...
      title: 'Ayuda',
      step1: {
        title: 'Paso 1: Elige un Rol',
        desc: 'Después de generar el proyecto, selecciona un rol de la lista (roles no del sistema marcados con 🟢)',
      },
      step2: {
        title: 'Paso 2: Completar las tareas',
        desc: 'Cada tarea representa un objetivo de aprendizaje:',
        s1: {
          title: 'Ver tarea actual',
          desc: "Consulta el título de la tarea, la descripción y a quién está asignada",
        },
        s2: {
          title: 'Conseguir ayuda',
          example: '@question ¿Por dónde debería empezar?\n@question ¿Cómo implemento esta función?',
          desc: 'El Agente de Preguntas brinda preguntas guía y pistas (no respuestas directas)',
        },
        s3: {
          title: 'Enviar tu trabajo',
          example: "@judge He terminado, revisa mis notas",
          desc: 'El Agente Juez evalúa tu trabajo y entrega comentarios:',
          complete: 'Avanza automáticamente a la próxima tarea',
          revision: 'Mejora en función de los comentarios',
        },
      },
      step3: {
        title: 'Paso 3: Completar el Proyecto',
        desc: 'Cuando todas las tareas estén hechas, el sistema muestra "🎉 ¡Proyecto Completado!"',
      },
    },
  },
  share: {
    notReady: 'Aparecerá después de que se complete la generación',
  },
} as const;
