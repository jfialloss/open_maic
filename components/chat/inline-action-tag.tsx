...
const WB_STYLE =
  'bg-sky-50 dark:bg-sky-500/15 border-sky-300/40 dark:border-sky-500/30 text-sky-600 dark:text-sky-300';
const WB_ACCENT = 'bg-sky-500 dark:bg-sky-400';
  ...
  return (
    ...
    >
      ...
      {isWb && (
        ...
        >
          <PenLine className="w-[7px] h-[7px] text-white dark:text-sky-950" strokeWidth={2.5} />
        </span>
      )}
