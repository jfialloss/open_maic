  ...
  if (notes.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center p-6">
        <div className="w-12 h-12 bg-blue-50 dark:bg-blue-900/20 rounded-2xl flex items-center justify-center mb-3 text-blue-300 dark:text-blue-600 ring-1 ring-blue-100 dark:ring-blue-800/30">
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isCurrent
                ? 'bg-blue-50/80 dark:bg-blue-950/25 ring-1 ring-blue-200/60 dark:ring-blue-700/30'
            ...
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <div
                className={cn(
                  ...
                  isCurrent
                    ? 'bg-blue-500 dark:bg-blue-400 shadow-sm shadow-blue-400/40'
              ...
              {isCurrent && (
                <span className="text-[9px] font-bold px-1.5 py-px rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-300">
