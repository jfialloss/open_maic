    ...
    <div className="h-[192px] w-full flex flex-col relative z-10 border-t border-gray-100 dark:border-gray-800 bg-white/60 dark:bg-gray-800/60 backdrop-blur-md">
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        <div className="w-[90px] shrink-0 flex flex-col border-r border-gray-100/50 dark:border-gray-700/50 bg-white/40 dark:bg-gray-900/40 overflow-visible relative">
          ...
          <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-blue-50/50 dark:from-blue-900/10 to-transparent pointer-events-none" />
          <div className="absolute top-3 inset-x-0 flex flex-col items-center justify-center gap-1 opacity-10 pointer-events-none">
            <BookOpen size={20} className="text-blue-900 dark:text-blue-100" />
            <div className="w-8 h-0.5 bg-blue-900 dark:bg-blue-100 rounded-full" />
          </div>
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          activeRole === 'teacher'
                            ? 'border-blue-500 dark:border-blue-400 shadow-[0_0_12px_rgba(168,85,247,0.4)]'
                    ...
                    <span
                      className={cn(
                        ...
                        activeRole === 'teacher' && !speakingStudent
                          ? 'text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-700'
                          : 'text-gray-400 dark:text-gray-500 border-gray-100 dark:border-gray-700 group-hover:text-blue-500 dark:group-hover:text-blue-400 group-hover:border-blue-200 dark:group-hover:border-blue-600',
                      )}
                    >
                      {teacherName}
                    </span>
          ...
          >
            ...
            <AnimatePresence>
              {isInputOpen && (
                ...
                >
                  <div className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-blue-200 dark:border-blue-700 flex items-end gap-2 ring-1 ring-blue-100/50 dark:ring-blue-800/50">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSendCooldown
                          ...
                          : 'bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 shadow-blue-200 dark:shadow-blue-900/50',
                      )}
                    >
                      {isSendCooldown ? (
              ...
              {isVoiceOpen && (
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl border border-blue-100 dark:border-blue-800 shadow-sm">
                      {[...Array(12)].map((_, i) => (
                        <motion.div
                          key={i}
                          animate={{
                          ...
                          className="w-1 bg-gradient-to-t from-blue-500 to-indigo-600 dark:from-blue-400 dark:to-indigo-500 rounded-full"
                        />
                      ))}
                    </div>
                    <motion.div
                      ...
                      className="text-[10px] font-bold tracking-widest text-blue-600 dark:text-blue-400 uppercase bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm border border-blue-100/50 dark:border-blue-800/50 mr-1"
                    >
                  ...
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-blue-600 to-indigo-700 dark:from-blue-500 dark:to-indigo-600 shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-300 border border-white/20 dark:border-white/10">
                      <Mic className="w-6 h-6 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-blue-500 dark:border-blue-400 opacity-40 animate-[ping_2s_ease-in-out_infinite] z-10" />
                    ...
                    <div className="absolute inset-0 bg-blue-600 dark:bg-blue-500 blur-2xl opacity-20 group-hover:opacity-40 transition-opacity z-0" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-blue-400/50 dark:border-blue-500/35',
                      )}
                    />
                    {/* Expanding ripple 2 */}
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-blue-300/40 dark:border-blue-400/25',
                      )}
                    />
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-blue-400 to-indigo-500 dark:from-blue-500 dark:to-indigo-600 shadow-blue-400/30 dark:shadow-blue-600/20 hover:shadow-blue-400/40 dark:hover:shadow-blue-600/30',
                      )}
                    >
                      {asrEnabled ? (
                    ...
                    <div className="flex items-center justify-center gap-[3px] h-3">
                      {[0, 1, 2, 3, 2, 1, 0].map((intensity, i) => (
                        <motion.div
                          ...
                          className="w-[2.5px] h-full origin-center rounded-full bg-blue-400/60 dark:bg-blue-500/50"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        bubbleRole === 'user'
                          ? 'bg-blue-600/95 dark:bg-blue-500/95 backdrop-blur-sm border-blue-400/40 dark:border-blue-300/40 text-white rounded-br-sm shadow-md shadow-blue-300/30 dark:shadow-blue-800/30'
                          : bubbleRole === 'agent'
                            ? cn(
                    ...
                    >
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          const barsColor =
                            bubbleRole === 'agent' ? 'bg-blue-500' : 'bg-blue-500';

                          if (btnState === 'none') return null;

                          if (btnState === 'play') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-blue-100 dark:hover:bg-blue-900/50 group-hover/bubble:bg-blue-100 dark:group-hover/bubble:bg-blue-900/50 transition-all duration-300 cursor-pointer">
                                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 group-hover/bubble:text-blue-600 dark:group-hover/bubble:text-blue-400 ml-0.5" />
                              </div>
                            );
                          }
                          ...
                          if (btnState === 'restart') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-blue-100 dark:hover:bg-blue-900/50 group-hover/bubble:bg-blue-100 dark:group-hover/bubble:bg-blue-900/50 transition-all duration-300 cursor-pointer">
                                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 group-hover/bubble:text-blue-600 dark:group-hover/bubble:text-blue-400" />
                              </div>
                            );
                          }
                          ...
                          // btnState === 'bars'
                          return (
                            <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 group-hover/bubble:bg-blue-100 dark:group-hover/bubble:bg-blue-900/50 transition-all duration-300">
                              ...
                              {/* Pause icon on hover */}
                              <Pause className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400 hidden group-hover/bubble:block" />
                            </div>
                          );
                        })()}
                    </div>
                          ...
                          >
                            <div
                              className={cn(
                                ...
                                isSpeaking
                                  ? 'border-blue-500 dark:border-blue-400 shadow-[0_0_8px_rgba(168,85,247,0.4)]'
                            ...
                            {isThinkingAgent && (
                              <div className="absolute inset-0 rounded-full border-2 border-blue-400 border-t-transparent animate-spin z-20" />
                            )}
                          </div>
                        </HoverCardTrigger>
                        <HoverCardContent
                  ...
                  <div className="flex items-center gap-[3px]">
                    {[0, 1, 2].map((i) => (
                      <motion.div
                        ...
                        className="w-[4px] h-[4px] rounded-full bg-blue-400 dark:bg-blue-400"
                      />
                    ))}
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ...
                        : isVoiceOpen
                          ? 'bg-blue-600 dark:bg-blue-500 border-blue-600 dark:border-blue-500 text-white shadow-blue-200 dark:shadow-blue-800'
                          : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-200 dark:hover:border-blue-700',
                    )}
                  >
                    {asrEnabled ? (
                  ...
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ? 'border-blue-600 dark:border-blue-400 shadow-[0_0_8px_rgba(168,85,247,0.3)]'
                        : 'border-white dark:border-gray-700 group-hover:border-blue-200 dark:group-hover:border-blue-600',
                  )}
                />
