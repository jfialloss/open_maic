  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-4 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-16 h-16 bg-gradient-to-br from-sky-100 to-blue-50 dark:from-sky-900/50 dark:to-blue-900/30 rounded-2xl flex items-center justify-center shadow-lg shadow-sky-100 dark:shadow-sky-900/30 ring-1 ring-sky-200/50 dark:ring-sky-700/50"
      >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="mt-1 px-8 py-2.5 bg-gradient-to-r from-sky-500 to-blue-500 text-white rounded-full font-medium shadow-lg shadow-sky-200/50 dark:shadow-sky-900/50 hover:shadow-sky-300/50 transition-shadow z-10 flex items-center gap-2"
      >
        {t('quiz.startQuiz')}
            ...
            >
              <span
                className={cn(
                  ...
                  !isReview && selected && 'bg-sky-500 text-white',
      ...
      {!isReview ? (
        <div className="relative">
          <textarea
            ...
            className="w-full min-h-[100px] p-3 pb-10 rounded-xl border border-gray-200 dark:border-gray-600 text-sm resize-none focus:outline-none focus:border-sky-300 dark:focus:border-sky-600 focus:ring-2 focus:ring-sky-100 dark:focus:ring-sky-900/50 transition-all disabled:bg-gray-50 dark:disabled:bg-gray-800 disabled:text-gray-500 dark:bg-gray-800/50 dark:text-gray-200 dark:placeholder:text-gray-500"
          />
          <SpeechButton
            size="sm"
            disabled={disabled}
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              ...
              <button
                ...
                className={cn(
                  ...
                  allAnswered
                    ? 'bg-gradient-to-r from-sky-500 to-blue-500 text-white shadow-sm hover:shadow-md hover:shadow-sky-200/50 dark:hover:shadow-sky-900/50 active:scale-[0.97]'
